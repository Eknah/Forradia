...
namespace Forradia
{
	          ...
	          private:
		          inline void InitializeEngine()
		          {
			          ...
			          GWindow = SDL_CreateWindow("Forradia", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, ScreenWidth, ScreenHeight, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN | SDL_WINDOW_FULLSCREEN_DESKTOP | SDL_WINDOW_RESIZABLE | SDL_WINDOW_MAXIMIZED);
