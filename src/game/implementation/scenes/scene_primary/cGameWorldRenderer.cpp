...
void cGameWorldRenderer::Render()
{
    ...
    auto player_y0 = 0.0f + Engine.Player.GetModule<cModuleJumping>().PositionZ;
    ...
    auto player_y1 = 0.0f + Engine.Player.GetModule<cModuleJumping>().PositionZ;
    ...
    auto player_y2 = 0.0f + Engine.Player.GetModule<cModuleJumping>().PositionZ;
    ...
    auto player_y3 = 0.0f + Engine.Player.GetModule<cModuleJumping>().PositionZ;
    ...
    Engine.DrawModel(mode_name_player, offset_x + Camera.GetRenderDistance() * Engine.TileSize + Engine.TileSize / 2.0f + sub_step_x * Engine.TileSize, 0.0f + Engine.Player.GetModule<cModuleJumping>().PositionZ, offset_y + Camera.GetRenderDistance() * Engine.TileSize - Engine.TileSize / 2.0f + sub_step_y * Engine.TileSize, Engine.Player.GetModule<cModuleMovement>().FacingAngleRotated);
