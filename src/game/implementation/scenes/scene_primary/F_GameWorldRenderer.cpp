...
void F_GameWorldRenderer::Render()
{
    ...
    auto player_y0 = 0.0 + Engine.Player.GetModule<F_ActorModuleJumping>("ModuleJumping").PositionZ;
    ...
    auto player_y1 = 0.0 + Engine.Player.GetModule<F_ActorModuleJumping>("ModuleJumping").PositionZ;
    ...
    auto player_y2 = 0.0 + Engine.Player.GetModule<F_ActorModuleJumping>("ModuleJumping").PositionZ;
    ...
    auto player_y3 = 0.0 + Engine.Player.GetModule<F_ActorModuleJumping>("ModuleJumping").PositionZ;
    ...
    if (Engine.Player.GetModule<F_ActorModuleMovement>("ModuleMovement").IsWalking)
    {
    ...
    Engine.DrawModel(mode_name_player, offset_x + Camera.GetRenderDistance() * Engine.TileSize + Engine.TileSize / 2 + sub_step_x * Engine.TileSize, 0.0 + Engine.Player.GetModule<F_ActorModuleJumping>("ModuleJumping").PositionZ, offset_y + Camera.GetRenderDistance() * Engine.TileSize - Engine.TileSize / 2 + sub_step_y * Engine.TileSize, Engine.Player.GetModule<F_ActorModuleMovement>("ModuleMovement").FacingAngleRotated);
