...
public:
    ...
    iEngine(iKeyboardHandler& KeyboardHandler_, iCustomCursor& CustomCursor_, iFpsCounter& FpsCounter_, iFullscreenController& FullscreenController_, iGameLoop& GameLoop_) : KeyboardHandler(KeyboardHandler_), CustomCursor(CustomCursor_), FpsCounter(FpsCounter_), FullscreenController(FullscreenController_), GameLoop(GameLoop_) {}
