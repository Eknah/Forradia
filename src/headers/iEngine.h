...
namespace Forradia
{
    ...
    public:
        ...
        virtual void DrawString(std::string message, SDL_Color color, Point2F point, bool centerAlign = false, float specificScaling = 1.0f) = 0;
        virtual void DrawString(std::string message, SDL_Color color, float x, float y, bool centerAlign = false, float specificScaling = 1.0f) = 0;
